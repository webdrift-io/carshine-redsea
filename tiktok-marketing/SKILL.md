...
Use `scripts/post-to-socials.js`:

```bash
node scripts/post-to-socials.js --config tiktok-marketing/config.json --dir tiktok-marketing/posts/YYYY-MM-DD-HHmm/ --caption "caption" --title "title" [--schedule "ISO-date"]
```
